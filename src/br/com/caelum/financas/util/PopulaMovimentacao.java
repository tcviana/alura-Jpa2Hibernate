...
public class PopulaMovimentacao {
	...
	public static void main(String[] args) {
		...
		movimentacao1.setTipoMovimentacao(TipoMovimentacao.DEBITO);
		...
		movimentacao4.setTipoMovimentacao(TipoMovimentacao.CREDITO);
		...
		movimentacao5.setTipoMovimentacao(TipoMovimentacao.DEBITO);
		...
		movimentacao6.setTipoMovimentacao(TipoMovimentacao.CREDITO);
		...
		movimentacao7.setTipoMovimentacao(TipoMovimentacao.DEBITO);
		...
		movimentacao8.setTipoMovimentacao(TipoMovimentacao.DEBITO);
		...
		movimentacao9.setTipoMovimentacao(TipoMovimentacao.CREDITO);
		...
		movimentacao10.setTipoMovimentacao(TipoMovimentacao.DEBITO);
		...
		movimentacao11.setTipoMovimentacao(TipoMovimentacao.CREDITO);
		...
		movimentacao12.setTipoMovimentacao(TipoMovimentacao.CREDITO);
